...
faq:
  ...
  - q: 転職のためのTOEICは何点を目指せばいいですか？
    a: まず600点が「履歴書に書いてマイナスにならないライン」で、公開テストの平均（約612点）とほぼ同じ水準です。英語を使う職種を狙うなら、受験者の上位約3分の1に入る700点が現実的な目標になります。IIBC公表データでは英語使用部署の中途採用で参考にされる平均は620点とされており、いきなり800点を目指す必要はありません。
...
| スコア | 受験者内での位置 | 市場での意味 |
| --- | --- | --- |
| 600点 | 公開テスト平均（約612点）とほぼ同水準 | 履歴書に書いてマイナスにならないライン。学習姿勢の証明 |
