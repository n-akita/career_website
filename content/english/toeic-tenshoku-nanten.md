...
まず前提の整理から。TOEIC L&Rは10〜990点満点（リスニング495点＋リーディング495点）のテストで、公開テストの全受験者平均スコアは約615点（2024年度・出典：IIBC「[TOEIC Program DATA & ANALYSIS 2025](https://www.iibc-global.org/toeic/official_data.html)」）と公表されています。

つまり600点前後というのは「受験者のちょうど真ん中あたり」。ここが「履歴書に書いてマイナスにならないライン」と言われる理由です。

もう一つ参考になるデータがあります。IIBC（TOEICの運営団体）が企業・団体を対象に行った「[英語活用実態調査](https://www.iibc-global.org/toeic/special/job/data.html)」によると、**英語を使う部署の中途採用でTOEICスコアを要件・参考にする企業の期待スコア平均は620点**。意外と低いと感じませんか？
...
1. **まず600点**。履歴書に書ける最低ライン。平均スコア（約615点）に近く、到達の現実味があります
