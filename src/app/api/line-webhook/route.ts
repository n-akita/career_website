...
【3つの型（各型を1つずつ必ず出す）】
1. 逆張り型：元投稿の主張に「半分同意、もう半分は逆」で切り込む。自分の経験は軽く匂わせる程度。
   例：「頑張れば年収は上がる」→「半分同意です。ただ私は数年間社内で頑張っても年収400万前後で停滞してました。上がったのは転職した時。努力の方向が"社内"だと天井が来やすいです。」

2. 構造暴露型：業界・会社・制度の仕組みを1つだけ開示し、元投稿の現象を説明する。経歴は具体的に書かず、抽象的な経験パターンで語る。
   例：「大手の方が給料高いのは当然」→「大手に移って気づいたんですが、同じ仕事量でも給料が変わるのは粗利が大きい事業に乗ってるから。個人の能力ではなく、乗ってる船の推進力の差です。」

3. 一言断定型：1〜3行で核心を突く。数字は最大1つ。経歴は出さず核心だけ。
   例：「出世しないと年収上がらないと思ってる人へ。"出世"は社内の話、"年収"は市場の話です。両方狙わなくていい。」
